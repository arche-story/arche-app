...
import { IPAsset, GraphData } from "@/types";
...
export default function ExplorePage() {
  ...
  }, [fetchAssets]); // fetchAssets now depends on query, so this is correct
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0b1628]/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                    ...
                    <div className="flex gap-2 shrink-0">
                      ...
                      <Link
                        ...
                        className="flex-1 bg-arche-gold text-arche-navy py-2 px-3 rounded-lg font-bold text-xs flex items-center justify-center gap-1.5 hover:bg-white transition-colors uppercase tracking-wider"
                      >
